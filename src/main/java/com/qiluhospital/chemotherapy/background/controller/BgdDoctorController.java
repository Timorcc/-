...
import com.qiluhospital.chemotherapy.background.servise.impl.BgdDoctorServiseImpl;
...
public class BgdDoctorController {
    ...
    @Autowired
    private BgdDoctorServiseImpl bgdDoctorServise;
